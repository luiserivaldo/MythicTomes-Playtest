...
- **Parry.** Roll 1d6 and add the number rolled to your Armor Class against the triggering attack, potentially causing the attack to miss. Until the end of the current turn, you also add that number to your Armor Class against other weapon attacks.
- **Retaliate.** Make one weapon attack against the triggering creature if it is within your weapon's range. On a hit, the attack deals 1d6 additional Force damage.
...
If you use Parry and the triggering attack still hits you, the use of Counterplay isn't expended. If you use Retaliate and the attack misses, the use of Counterplay isn't expended.
...
The creature can repeat the save at the start of each of its turns, ending the condition on itself on a success.

If the creature is affected by your _Hunter's Mark_, it has disadvantage on the saving throw.
