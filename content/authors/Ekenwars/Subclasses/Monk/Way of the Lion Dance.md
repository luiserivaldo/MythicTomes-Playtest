...
Your long jump distance becomes 20 feet and your high jump becomes 15 feet, and you can make these jumps without a running start.

When you complete a jump of at least 10 feet and land, you can perform a Leaping Strike and make one unarmed strike against a creature within your reach. On a hit, the attack deals additional damage equal to your proficiency bonus.

When you use Leaping Strike and take damage from falling during the same movement, reduce the fall distance used to calculate that damage by the height of your jump.

You can use Leaping Strike twice, and you regain all expended uses when you finish a Short or Long Rest. On your turn, you can expend 1 Focus Point to regain 1 expended use of Leaping Strike (no action required).
...
When you use Step of the Wind, you can enter a Lion Dance until the end of your turn.

While in this state, you can extend a jump while airborne, increasing its total distance by an amount up to your current jump distance. You can do this once per turn.

In addition, once on each of your turns when you use Leaping Strike, you can make one additional unarmed strike against the same target.

Finally, your Leaping Strikes ignore damage resistances.
